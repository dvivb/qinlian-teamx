    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php $form = ActiveForm::begin(["id" => "qinlian-petition-archives-form", "class"=>"form-horizontal", "action"=>Url::toRoute("qinlian-register/annex-save"), 'options' => ['enctype' => 'multipart/form-data']]); ?>
...
<script>
    function deleteAction(id){
        $.ajax({
            type: "GET",
            url: "<?=Url::toRoute('qinlian-register/annex-delete')?>",
            data: {"id":id},
            cache: false,
            dataType:"json",
    ...
    $('#qinlian-petition-archives-form').bind('submit', function(e) {
        ...
        var action = "<?=Url::toRoute('qinlian-register/annex-create')?>";
        $(this).ajaxSubmit({
            type: "post",
            dataType:"json",
            url: action,
