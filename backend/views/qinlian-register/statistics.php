	...
	<div class="modal-dialog">
		<div class="modal-content">
          ...
          <div id="name_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="name" name="QinlianRegister[name]" placeholder="" />
              </div>
          ...
          <div id="politics_status_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="politics_status" name="QinlianRegister[politics_status]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="join_party_date_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="join_party_date" name="QinlianRegister[join_party_date]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="organization_name_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="organization_name" name="QinlianRegister[organization_name]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="duty_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="duty" name="QinlianRegister[duty]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="rank_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="rank" name="QinlianRegister[rank]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="is_monitor_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="is_monitor" name="QinlianRegister[is_monitor]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="is_official_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="is_official" name="QinlianRegister[is_official]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="clue_code_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="clue_code" name="QinlianRegister[clue_code]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="clue_people_code_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="clue_people_code" name="QinlianRegister[clue_people_code]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="clue_accept_time_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="clue_accept_time" name="QinlianRegister[clue_accept_time]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="clue_manage_office_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="clue_manage_office" name="QinlianRegister[clue_manage_office]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="clue_source_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="clue_source" name="QinlianRegister[clue_source]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="clue_violations_type_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="clue_violations_type" name="QinlianRegister[clue_violations_type]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="clue_outlawed_type_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="clue_outlawed_type" name="QinlianRegister[clue_outlawed_type]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="clue_disposition_method_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="clue_disposition_method" name="QinlianRegister[clue_disposition_method]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="clue_summary_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="clue_summary" name="QinlianRegister[clue_summary]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="clue_protokaryon_report_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="clue_protokaryon_report" name="QinlianRegister[clue_protokaryon_report]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="case_people_code_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="case_people_code" name="QinlianRegister[case_people_code]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="case_register_time_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="case_register_time" name="QinlianRegister[case_register_time]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="case_register_office_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="case_register_office" name="QinlianRegister[case_register_office]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="case_summary_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="case_summary" name="QinlianRegister[case_summary]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="case_register_report_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="case_register_report" name="QinlianRegister[case_register_report]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="case_register_decision_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="case_register_decision" name="QinlianRegister[case_register_decision]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="case_review_report_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="case_review_report" name="QinlianRegister[case_review_report]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="settle_accept_time_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="settle_accept_time" name="QinlianRegister[settle_accept_time]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="settle_accept_report_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="settle_accept_report" name="QinlianRegister[settle_accept_report]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="settle_conclude_time_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="settle_conclude_time" name="QinlianRegister[settle_conclude_time]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="settle_finish_time_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="settle_finish_time" name="QinlianRegister[settle_finish_time]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="settle_party_disposal_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="settle_party_disposal" name="QinlianRegister[settle_party_disposal]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="settle_political_disposal_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="settle_political_disposal" name="QinlianRegister[settle_political_disposal]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="settle_disposal_decision_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="settle_disposal_decision" name="QinlianRegister[settle_disposal_decision]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="settle_judiciary_time_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="settle_judiciary_time" name="QinlianRegister[settle_judiciary_time]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="settle_prosecutor_time_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="settle_prosecutor_time" name="QinlianRegister[settle_prosecutor_time]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="settle_prosecutor_details_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="settle_prosecutor_details" name="QinlianRegister[settle_prosecutor_details]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
