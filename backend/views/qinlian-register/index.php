        ...
        <div class="box-body">
          <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap table-responsive">
            ...
            foreach ($models as $model) {
                ...
                echo '  <td>' . mb_substr($model->supervises_object_details, 0, 60) . '</td>';
                echo '  <td>' . $model->is_party . '</td>';
                echo '  <td>' . $model->party_delegate . '</td>';
                echo '  <td>' . mb_substr($model->disposal_report, 0, 60) . '</td>';
                echo '  <td>' . $model->time_joining_party . '</td>';
                echo '  <td>' . $model->no_party_objects . '</td>';
                echo '  <td>' . mb_substr($model->no_party_objects_details, 0, 60) . '</td>';
                ...
                echo '  <td>' . mb_substr($model->head_violating, 0, 60) . '</td>';
                echo '  <td>' . mb_substr($model->head_details, 0, 60) . '</td>';
                echo '  <td>' . mb_substr($model->head_details_two, 0, 60) . '</td>';
                ...
                echo '  <td>' . mb_substr($model->jobbery_lose, 0, 60) . '</td>';
                ...
                echo '  <td>' . mb_substr($model->brief_case_report, 0, 60) . '</td>';
                echo '  <td>' . mb_substr($model->register_report, 0, 60) . '</td>';
                echo '  <td>' . mb_substr($model->register_decide_book, 0, 60) . '</td>';
                echo '  <td>' . mb_substr($model->remarks, 0, 60) . '</td>';
                ...
                echo '  <td>' . mb_substr($model->accountability, 0, 60) . '</td>';
                echo '  <td>' . mb_substr($model->party_discipline, 0, 60) . '</td>';
                ...
                echo '  <td>' . mb_substr($model->public_inspection_processing, 0, 60) . '</td>';
                echo '  <td>' . mb_substr($model->public_inspection_processing_detail, 0, 60) . '</td>';
                ...
                echo '  <td>' . mb_substr($model->investigation_report, 0, 60) . '</td>';
                echo '  <td>' . mb_substr($model->trial_report, 0, 60) . '</td>';
                echo '  <td>' . mb_substr($model->case_analysis, 0, 60) . '</td>';
                echo '  <td>' . $model->party_watch_limit . '</td>';
                echo '  <td>' . $model->enterprise_level . '</td>';
                echo '  <td>' . $model->flight_direction . '</td>';
                echo '  <td>' . mb_substr($model->flight_direction_details, 0, 60) . '</td>';
                ...
                echo '  <td>' . mb_substr($model->delay_approval_situation, 0, 60) . '</td>';
                echo '  <td>' . mb_substr($model->organization_measure, 0, 60) . '</td>';
                ...
                echo '  <td>' . mb_substr($model->confessional_books, 0, 60) . '</td>';
