...
<!--            </div>-->
              ...
              <div class="row" style="display: none;">
                  <div class="col-sm-12">
                      <?php ActiveForm::begin(['id' => 'qinlian-register-export-form', 'method'=>'get', 'options' => ['class' => 'form-inline'], 'action'=>Url::toRoute('qinlian-register/export')]); ?>
        ...
        <div class="box-body">
          <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap table-responsive">
            ...
            <?php 
              ...
              echo '<th onclick="orderby(\'supervises_object_details\', \'desc\')" class="th-width-1" tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" >'.$modelLabel->getAttributeLabel('supervises_object_details').'</th>';
              ...
              echo '<th onclick="orderby(\'no_party_objects_details\', \'desc\')" class="th-width-1" tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" >'.$modelLabel->getAttributeLabel('no_party_objects_details').'</th>';
              ...
              echo '<th onclick="orderby(\'head_violating\', \'desc\')" class="th-width-1" tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" >'.$modelLabel->getAttributeLabel('head_violating').'</th>';
              echo '<th onclick="orderby(\'head_details\', \'desc\')" class="th-width-1" tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" >'.$modelLabel->getAttributeLabel('head_details').'</th>';
              echo '<th onclick="orderby(\'head_details_two\', \'desc\')" class="th-width-1" tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" >'.$modelLabel->getAttributeLabel('head_details_two').'</th>';
              ...
              echo '<th onclick="orderby(\'jobbery_lose\', \'desc\')" class="th-width-1" tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" >'.$modelLabel->getAttributeLabel('jobbery_lose').'</th>';
              ...
              echo '<th onclick="orderby(\'brief_case_report\', \'desc\')" class="th-width-2" tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" >'.$modelLabel->getAttributeLabel('brief_case_report').'</th>';
              echo '<th onclick="orderby(\'register_report\', \'desc\')" class="th-width-2" tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" >'.$modelLabel->getAttributeLabel('register_report').'</th>';
              echo '<th onclick="orderby(\'register_decide_book\', \'desc\')" class="th-width-1" tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" >'.$modelLabel->getAttributeLabel('register_decide_book').'</th>';
              ...
              echo '<th onclick="orderby(\'accountability\', \'desc\')" class="th-width-1" tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" >'.$modelLabel->getAttributeLabel('accountability').'</th>';
              echo '<th onclick="orderby(\'party_discipline\', \'desc\')" class="th-width-1" tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" >'.$modelLabel->getAttributeLabel('party_discipline').'</th>';
              ...
              echo '<th onclick="orderby(\'public_inspection_processing\', \'desc\')" class="th-width-1" tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" >'.$modelLabel->getAttributeLabel('public_inspection_processing').'</th>';
              echo '<th onclick="orderby(\'public_inspection_processing_detail\', \'desc\')" class="th-width-1" tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" >'.$modelLabel->getAttributeLabel('public_inspection_processing_detail').'</th>';
              ...
              echo '<th onclick="orderby(\'investigation_report\', \'desc\')" class="th-width-2" tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" >'.$modelLabel->getAttributeLabel('investigation_report').'</th>';
              echo '<th onclick="orderby(\'trial_report\', \'desc\')" class="th-width-2" tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" >'.$modelLabel->getAttributeLabel('trial_report').'</th>';
              echo '<th onclick="orderby(\'case_analysis\', \'desc\')" class="th-width-1" tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" >'.$modelLabel->getAttributeLabel('case_analysis').'</th>';
              ...
              echo '<th onclick="orderby(\'flight_direction_details\', \'desc\')" class="th-width-1" tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" >'.$modelLabel->getAttributeLabel('flight_direction_details').'</th>';
              ...
              echo '<th onclick="orderby(\'delay_approval_situation\', \'desc\')" class="th-width-1" tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" >'.$modelLabel->getAttributeLabel('delay_approval_situation').'</th>';
              echo '<th onclick="orderby(\'organization_measure\', \'desc\')" class="th-width-1" tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" >'.$modelLabel->getAttributeLabel('organization_measure').'</th>';
	...
	<div class="modal-dialog">
		<div class="modal-content">
          ...
          <div id="nuit_name_div" class="form-group">
              ...
              <div class="col-sm-4">
                  <input type="text" class="form-control" id="nuit_name" name="department_charge[nuit_name]" placeholder="" />
              </div>
...
<!--                  <input type="text" class="form-control" id="is_party" name="QinlianRegister[is_party]" placeholder="必填" />-->
          ...
          <div id="party_delegate_div" class="form-group">
              ...
              <div class="col-xs-10">
                  <textarea type="text" class="form-control" id="supervises_object_details" name="QinlianRegister[supervises_object_details]" placeholder="必填" ></textarea>
              </div>

              <label for="disposal_report" class="col-sm-2 control-label"><?php echo $modelLabel->getAttributeLabel("disposal_report")?></label>
              <div class="col-xs-10">
                  <textarea type="text" class="form-control" id="disposal_report" name="QinlianRegister[disposal_report]" placeholder="" ></textarea>
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="no_party_objects_details_div" class="form-group">
              ...
              <div class="col-xs-10">
                  <textarea type="text" class="form-control" id="no_party_objects_details" name="QinlianRegister[no_party_objects_details]" placeholder="" ></textarea>
              </div>
          ...
          <div id="head_violating_div" class="form-group">
              ...
              <div class="col-xs-10">
                  <textarea type="text" class="form-control" id="head_violating" name="QinlianRegister[head_violating]" placeholder="" ></textarea>
              </div>

              <label for="head_details" class="col-sm-2 control-label"><?php echo $modelLabel->getAttributeLabel("head_details")?></label>
              <div class="col-xs-10">
                  <textarea type="text" class="form-control" id="head_details" name="QinlianRegister[head_details]" placeholder="" ></textarea>
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="head_details_two_div" class="form-group">
              ...
              <div class="col-xs-10">
                  <textarea type="text" class="form-control" id="head_details_two" name="QinlianRegister[head_details_two]" placeholder="" ></textarea>
              </div>
          ...
          <div id="jobbery_lose_div" class="form-group">
              ...
              <div class="col-xs-10">
                  <textarea type="text" class="form-control" id="jobbery_lose" name="QinlianRegister[jobbery_lose]" placeholder="" ></textarea>
              </div>
...
<!--                  <input type="text" class="form-control" id="is_discipline_transfer" name="QinlianRegister[is_discipline_transfer]" placeholder="必填" />-->
          ...
          <div id="brief_case_report_div" class="form-group">
              ...
              <div class="col-xs-10">
                  <textarea type="text" class="form-control" id="brief_case_report" name="QinlianRegister[brief_case_report]" placeholder="" ></textarea>
              </div>

              <label for="register_report" class="col-sm-2 control-label"><?php echo $modelLabel->getAttributeLabel("register_report")?></label>
              <div class="col-xs-10">
                  <textarea type="text" class="form-control" id="register_report" name="QinlianRegister[register_report]" placeholder="" ></textarea>
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="register_decide_book_div" class="form-group">
              ...
              <div class="col-xs-10">
                  <textarea type="text" class="form-control" id="register_decide_book" name="QinlianRegister[register_decide_book]" placeholder="" ></textarea>
              </div>

              <label for="remarks" class="col-sm-2 control-label"><?php echo $modelLabel->getAttributeLabel("remarks")?></label>
              <div class="col-xs-10">
                  <textarea type="text" class="form-control" id="remarks" name="QinlianRegister[remarks]" placeholder="" ></textarea>
              </div>
              <div class="clearfix"></div>
          </div>
...
<!--                  <input type="text" class="form-control" id="is_accountabilitye" name="QinlianRegister[is_accountabilitye]" placeholder="必填" />-->
          ...
          <div id="party_discipline_div" class="form-group">
              ...
              <div class="col-xs-10">
                  <textarea type="text" class="form-control" id="accountability" name="QinlianRegister[accountability]" placeholder="" ></textarea>
              </div>

              <label for="party_discipline" class="col-sm-2 control-label"><?php echo $modelLabel->getAttributeLabel("party_discipline")?></label>
              <div class="col-xs-10">
                  <textarea type="text" class="form-control" id="party_discipline" name="QinlianRegister[party_discipline]" placeholder="" ></textarea>
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="administrative_sanction_div" class="form-group">
              ...
              <div class="col-xs-10">
                  <textarea type="text" class="form-control" id="administrative_sanction" name="QinlianRegister[administrative_sanction]" placeholder="" ></textarea>
              </div>
          ...
          <div id="public_inspection_processing_div" class="form-group">
              ...
              <div class="col-xs-10">
                  <textarea type="text" class="form-control" id="public_inspection_processing" name="QinlianRegister[public_inspection_processing]" placeholder="" ></textarea>
              </div>
              ...
              <div class="col-xs-10">
                  <textarea type="text" class="form-control" id="public_inspection_processing_detail" name="QinlianRegister[public_inspection_processing_detail]" placeholder="" ></textarea>
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="investigation_report_div" class="form-group">
              ...
              <div class="col-xs-10">
                  <textarea type="text" class="form-control" id="investigation_report" name="QinlianRegister[investigation_report]" placeholder="" ></textarea>
              </div>

              <label for="trial_report" class="col-sm-2 control-label"><?php echo $modelLabel->getAttributeLabel("trial_report")?></label>
              <div class="col-xs-10">
                  <textarea type="text" class="form-control" id="trial_report" name="QinlianRegister[trial_report]" placeholder="" ></textarea>
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="case_analysis_div" class="form-group">
              ...
              <div class="col-xs-10">
                  <textarea type="text" class="form-control" id="case_analysis" name="QinlianRegister[case_analysis]" placeholder="" ></textarea>
              </div>
          ...
          <div id="organization_measure_div" class="form-group">
              ...
              <div class="col-xs-10">
                  <textarea type="text" class="form-control" id="delay_approval_situation" name="QinlianRegister[delay_approval_situation]" placeholder="" ></textarea>
              </div>
              ...
              <div class="col-xs-10">
                  <textarea type="text" class="form-control" id="organization_measure" name="QinlianRegister[organization_measure]" placeholder="" ></textarea>
              </div>

              <label for="confessional_books" class="col-sm-2 control-label"><?php echo $modelLabel->getAttributeLabel("confessional_books")?></label>
              <div class="col-xs-10">
                  <textarea type="text" class="form-control" id="confessional_books" name="QinlianRegister[confessional_books]" placeholder="" ></textarea>
              </div>
              <div class="clearfix"></div>
          </div>
...
<!--                  <input type="text" class="form-control" id="department_charge" name="QinlianRegister[department_charge]" placeholder="" />-->
          ...
          <div id="department_charge_div" class="form-group">
              ...
              <div class="col-sm-4">
                  <input type="text" class="form-control" id="id_card" name="QinlianRegister[id_card]" placeholder=""/>
              </div>
              <div class="clearfix"></div>
          </div>
...
<div class="modal fade" id="uploadFile" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <form action="<?=Url::toRoute('qinlian-register/import')?>" method="post" id="qinlian-register-import-form" enctype="multipart/form-data">
...
<div class="modal fade" id="archives" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php $form = ActiveForm::begin(["id" => "qinlian-register-archives-form", "class"=>"form-horizontal", "action"=>Url::toRoute("qinlian-register/save")]); ?>
                ...
                <div id="number_div" class="form-group">
                    ...
                    <div class="col-sm-4">
                        <select class="form-control" id="disposal_method" name="QinlianRegister[disposal_method]" >
                            <option>谈话函询</option>
                            <option>初步核实</option>
                            <option>暂存待查</option>
                            <option>予以了结</option>
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="archives-number" name="QinlianRegister[number]" />
                    </div>
                    <div class="clearfix"></div>
                </div>
                ...
                <div id="is_thread_disposal_div" class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="volume_number" name="QinlianRegister[volume_number]"/>
                    </div>

                    <label for="disposal_year" class="col-sm-2 control-label"><?php echo $modelLabel->getAttributeLabel("disposal_year")?></label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="disposal_year" name="QinlianRegister[disposal_year]" data-provide="datepicker" data-date-format="yyyy" />
                    </div>
                    <div class="clearfix"></div>
                </div>
                ...
                <div id="create_date_div" class="form-group">
                    <label for="department_charge" class="col-sm-2 control-label"><?php echo $modelLabel->getAttributeLabel("department_charge")?></label>
                    <div class="col-sm-4">
                        <select class="form-control" id="archives-department_charge" name="QinlianRegister[department_charge]">
                            <option>科室一</option>
                            <option>科室二</option>
                            <option>科室三</option>
                        </select>
...
function exportAction(){
    $('#qinlian-register-export-form').submit();
}
...
$('#qinlian-register-import-form').bind('submit', function(e) {
    e.preventDefault();
    var action = "<?=Url::toRoute('qinlian-register/import')?>";
    $(this).ajaxSubmit({
        type: "post",
        dataType:"json",
        url: action,
...
<script>
    ...
    $('#archives_dialog_ok').click(function (e) {
        e.preventDefault();
        $('#qinlian-register-archives-form').submit();
    });

    $('#qinlian-register-archives-form').bind('submit', function(e) {
        e.preventDefault();
        var id = $("#archives-id").val();
        var action = "<?=Url::toRoute('qinlian-register/update')?>";
        $(this).ajaxSubmit({
            type: "post",
            dataType:"json",
            url: action,
