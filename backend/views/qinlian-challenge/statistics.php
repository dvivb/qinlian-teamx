	...
	<div class="modal-dialog">
		<div class="modal-content">
          ...
          <div id="name_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="name" name="QinlianChallenge[name]" placeholder="" />
              </div>
          ...
          <div id="sex_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="sex" name="QinlianChallenge[sex]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="nation_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="nation" name="QinlianChallenge[nation]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="age_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="age" name="QinlianChallenge[age]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="politics_status_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="politics_status" name="QinlianChallenge[politics_status]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="join_party_date_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="join_party_date" name="QinlianChallenge[join_party_date]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="organization_name_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="organization_name" name="QinlianChallenge[organization_name]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="duty_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="duty" name="QinlianChallenge[duty]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="rank_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="rank" name="QinlianChallenge[rank]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="is_monitor_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="is_monitor" name="QinlianChallenge[is_monitor]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="is_official_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="is_official" name="QinlianChallenge[is_official]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="clue_code_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="clue_code" name="QinlianChallenge[clue_code]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="clue_people_code_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="clue_people_code" name="QinlianChallenge[clue_people_code]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="clue_accept_time_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="clue_accept_time" name="QinlianChallenge[clue_accept_time]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="clue_manage_office_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="clue_manage_office" name="QinlianChallenge[clue_manage_office]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="clue_violations_type_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="clue_violations_type" name="QinlianChallenge[clue_violations_type]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="clue_outlawed_type_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="clue_outlawed_type" name="QinlianChallenge[clue_outlawed_type]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="clue_disposition_method_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="clue_disposition_method" name="QinlianChallenge[clue_disposition_method]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="clue_summary_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="clue_summary" name="QinlianChallenge[clue_summary]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="clue_protokaryon_report_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="clue_protokaryon_report" name="QinlianChallenge[clue_protokaryon_report]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="case_code_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="case_code" name="QinlianChallenge[case_code]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="case_people_code_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="case_people_code" name="QinlianChallenge[case_people_code]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="case_register_time_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="case_register_time" name="QinlianChallenge[case_register_time]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="case_register_office_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="case_register_office" name="QinlianChallenge[case_register_office]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="case_summary_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="case_summary" name="QinlianChallenge[case_summary]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="case_register_report_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="case_register_report" name="QinlianChallenge[case_register_report]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="case_register_decision_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="case_register_decision" name="QinlianChallenge[case_register_decision]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="case_review_report_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="case_review_report" name="QinlianChallenge[case_review_report]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="settle_accept_time_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="settle_accept_time" name="QinlianChallenge[settle_accept_time]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="settle_accept_report_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="settle_accept_report" name="QinlianChallenge[settle_accept_report]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="settle_conclude_time_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="settle_conclude_time" name="QinlianChallenge[settle_conclude_time]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="settle_finish_time_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="settle_finish_time" name="QinlianChallenge[settle_finish_time]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="settle_party_disposal_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="settle_party_disposal" name="QinlianChallenge[settle_party_disposal]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="settle_political_disposal_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="settle_political_disposal" name="QinlianChallenge[settle_political_disposal]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="settle_disposal_decision_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="settle_disposal_decision" name="QinlianChallenge[settle_disposal_decision]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="settle_judiciary_time_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="settle_judiciary_time" name="QinlianChallenge[settle_judiciary_time]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="settle_prosecutor_time_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="settle_prosecutor_time" name="QinlianChallenge[settle_prosecutor_time]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="settle_prosecutor_details_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="settle_prosecutor_details" name="QinlianChallenge[settle_prosecutor_details]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
