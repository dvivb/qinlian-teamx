        ...
        <div class="box-header">
          ...
          <div class="box-tools">
            <div class="input-group input-group-sm" >
                ...
                |
                <a href="<?=Url::toRoute('case-record/export')?>" class="btn btn-xs btn-info">导&nbsp;&emsp;出</a>
                |
...
<div class="modal fade" id="uploadFile" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <form action="<?=Url::toRoute('case-record/import')?>" method="post" enctype="multipart/form-data">
