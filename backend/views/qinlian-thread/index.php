        ...
        <div class="box-body">
          <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap table-responsive">
            ...
            foreach ($models as $model) {
                ...
                echo '  <td>' . mb_substr($model->main_problem_clues, 0, 60) . '</td>';
                ...
                echo '  <td>' . mb_substr($model->one_level_first, 0, 60) . '</td>';
                echo '  <td>' . mb_substr($model->one_level_second, 0, 60) . '</td>';
                echo '  <td>' . $model->approval_time_two . '</td>';
                echo '  <td>' . $model->statistical_time_two . '</td>';
                echo '  <td>' . mb_substr($model->two_level_first, 0, 60) . '</td>';
                echo '  <td>' . mb_substr($model->two_level_second, 0, 60) . '</td>';
                echo '  <td>' . $model->approval_time_three . '</td>';
                echo '  <td>' . $model->statistical_time_three . '</td>';
                echo '  <td>' . mb_substr($model->three_level_first, 0, 60) . '</td>';
                echo '  <td>' . mb_substr($model->three_level_second, 0, 60) . '</td>';
                echo '  <td>' . mb_substr($model->cases_source, 0, 60) . '</td>';
                echo '  <td>' . mb_substr($model->disciplinary_offence, 0, 60) . '</td>';
                ...
                echo '  <td>' . mb_substr($model->official_offences, 0, 60) . '</td>';
                echo '  <td>' . mb_substr($model->other_offences, 0, 60) . '</td>';
