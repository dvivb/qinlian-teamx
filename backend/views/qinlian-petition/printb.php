    ...
    <div class="row">
        <div class="col-sm-12">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                <tr>
                    <td align="center" colspan="8" class="biaoti btbg" height="60" style="font-family: SimSun;size: 18px;">纪检监察机关来信来访来电批办单</td>
                </tr>
                <tr>
            ...
            <table width="100%" border="1" cellspacing="1" cellpadding="1" bgcolor="#cccccc" class="tabtop13" align="center">
                ...
                <tr>
                    <td width="2%" class="btbg font-center titfont tdrows-2" >信访室意见</td>
